...
defaults('ADMIN_PASSWORD','123456845d5s3w4¤#¤ssedd');  	// Admin Password - CHANGE THIS TO ENABLE!!!
...
$MY_SELF_WO_SORT=
	...
	"?SCOPE=".$MYREQUEST['SCOPE'].
	"&COUNT=".$MYREQUEST['COUNT'];
Zend_Registry::set('my_self', $MY_SELF);
Zend_Registry::set('my_self_wo_sort', $MY_SELF_WO_SORT);
Zend_Registry::set('my_req', $MYREQUEST);
...
function menu_entry($ob,$title) {
	$MY_SELF = Zend_Registry::get('my_self');
	$MYREQUEST = Zend_Registry::get('my_req');
	if ($MYREQUEST['OB']!=$ob) {
