...
Zend_Registry::set('memcache_servers', $MEMCACHE_SERVERS);
...
function sendMemcacheCommands($command){
    $MEMCACHE_SERVERS = Zend_Registry::get('memcache_servers');
	$result = array();
...
function menu_entry($ob,$title) {
	$PHP_SELF = Zend_Registry::get('php_self');
	if ($ob==$_GET['op']){
...
$PHP_SELF=$PHP_SELF.'?';
Zend_Registry::set('php_self', $PHP_SELF);
$time = time();
// sanitize _GET
